...
2. Two sample t test - comparing two different samples means.
...
```
Now, you need to conduct three tests between 2 groups
:
...
Writing it up:
The Chi-squared test for given probabilities / goodness of fit of groups to
a distribution of [n=148.25, n=444.75] suggests that the effect is
statistically significant X2 (1, = 66.91, p < .001.
