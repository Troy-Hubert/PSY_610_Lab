...
A Wilcoxon signed-rank test was computed to assess whether the sample median depression was different to the population normal median depression (25). The measured student median depression (40) was statistically significantly lower than the population median depression of 25 (p < 0.001, effect size r = 0.88).
...
A Wilcoxon signed-rank test was computed to assess whether depression differs by sex within a student sample. The median depression in female group was 44 (IQR = 18.50), whereas the median in male group was 39.9 (IQR = 15.25). The Wilcoxon test showed that the difference was not significant (z = -0.36, p = 0.73, effect size r = 0.06).
...
A paired sample Wilcoxon signed rank test was conducted to example differences pre and post depression treatmen. The median depression of the participants before treatment is significantly higher (M = 40) from the median depression score after treatment (M = 27) with a p-value < 0.001 and effect size of r = 0.87.
