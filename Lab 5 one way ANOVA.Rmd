...
The output of the ANOVA usually gives us the eta^2^ We are interested in calculating cohens f^2^, which is a similar statistic to cohen's d, but for ANOVA. Here is a table showing you the effect size based upon f^2^ and eta^2^ values.

| Effect Size | f^2^ value | eta^2^ |
|:-----------:|:----------:|:------:|
|    Small    |    0.1     |  0.01  |
|   Medium    |    0.25    |  0.06  |
|    Large    |    0.4     |  0.14  |
